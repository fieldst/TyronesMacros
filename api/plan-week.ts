...
function equipmentRulesText(equipment: string[]) {
  ...
  return {lines: lines, barMax, rules};
}
function sanitizeTextLbs(s: string): string {
  return s.replace(/(\d+)s\/(\d+)s/g, (m,a,b)=>`2 × ${a} lb DB / 2 × ${b} lb DB`).replace(/(\d+)\s?lbs?\b/gi, (m,a)=>`${a} lb`);
}
  ...
  'HIIT': {
    plan: [
      ...
      },
      {
        ...
        blocks: [
          { exercise: 'Walking', minutes: 30 },
          { exercise: 'Stretching', minutes: 15 }
        ],
      ...
      },
      {
        ...
        blocks: [
          { exercise: 'Sprint Intervals', minutes: 20 },
          { exercise: 'Cool Down Walk', minutes: 10 }
        ],
      ...
      },
      {
        ...
        title: 'Rest Day',
        blocks: [
          { exercise: 'Gentle Yoga', minutes: 20 },
          { exercise: 'Meditation', minutes: 10 }
        ],
        estimated_calories: 80,
        notes: 'Recovery and relaxation'
      }
    ],
    benefits: 'HIIT workouts burn calories efficiently, improve cardiovascular fitness, and can be completed in short time periods. Great for fat loss and metabolic conditioning.'
  },
  'Cardio Focus': {
    plan: [
      {
        ...
        blocks: [
          { exercise: 'Brisk Walking', minutes: 30 },
          { exercise: 'Light Stretching', minutes: 10 }
        ],
        estimated_calories: 200,
      ...
      },
      {
        ...
        blocks: [
          { exercise: 'Walk/Jog Intervals', minutes: 25 },
          { exercise: 'Cool Down', minutes: 5 }
        ],
      ...
      },
      {
        ...
        blocks: [
          { exercise: 'Swimming or Water Walking', minutes: 30 }
        ],
      ...
      },
      {
        ...
        title: 'Dance Cardio',
        blocks: [
          { exercise: 'Dance Workout', minutes: 30 },
          { exercise: 'Stretching', minutes: 10 }
        ],
        estimated_calories: 280,
      ...
      },
      {
        ...
        title: 'Hill Walking',
        blocks: [
          { exercise: 'Incline Walking', minutes: 35 }
        ],
        estimated_calories: 300,
      ...
      },
      {
        ...
        blocks: [
          { exercise: 'Continuous Walking/Cycling', minutes: 45 }
        ],
        estimated_calories: 350,
      ...
      },
      {
        ...
        title: 'Active Recovery',
        blocks: [
          { exercise: 'Gentle Yoga', minutes: 30 }
        ],
        estimated_calories: 120,
        notes: 'Recovery and flexibility'
      }
    ],
    benefits: 'Cardio workouts improve heart health, endurance, and are excellent for weight management. Progressive approach builds fitness safely.'
  },
  'Strength + Cardio': {
    plan: [
      {
      ...
      },
      {
        ...
        blocks: [
          { exercise: 'Running/Cycling', minutes: 20 },
          { exercise: 'Cool Down', minutes: 10 }
        ],
        estimated_calories: 300,
      ...
      },
      {
        ...
        title: 'Active Recovery',
        blocks: [
          { exercise: 'Light Walking', minutes: 30 },
          { exercise: 'Stretching', minutes: 15 }
        ],
        estimated_calories: 150,
      ...
      },
      {
        ...
        blocks: [
          { exercise: 'Steady State Cardio', minutes: 40 }
        ],
        estimated_calories: 320,
      ...
      },
      {
        ...
        title: 'Rest Day',
        blocks: [
          { exercise: 'Yoga or Meditation', minutes: 20 }
        ],
        estimated_calories: 80,
        notes: 'Complete rest and recovery'
      }
    ],
    benefits: 'Combining strength and cardio provides balanced fitness development, improves both muscle strength and cardiovascular health.'
  },
  'CrossFit Style': {
    plan: [
      {
      ...
      },
      {
        ...
        blocks: [
          { exercise: '100 Burpees for time', minutes: 15 },
          { exercise: 'Cool down walk', minutes: 10 }
        ],
      ...
      },
      {
        ...
        title: 'Active Recovery',
        blocks: [
          { exercise: 'Mobility Work', minutes: 30 },
          { exercise: 'Light Movement', minutes: 15 }
        ],
        estimated_calories: 120,
        notes: 'Recovery and preparation'
      }
    ],
    benefits: 'CrossFit style training develops functional fitness, builds community, and provides constantly varied workouts that prevent boredom.'
  }
};
...
function getFallbackPlan(style: string, daysAvailable: number, minutes: number) {
  ...
  const planKey = Object.keys(FALLBACK_PLANS).find(key => 
...
export const POST = wrap(async (req: Request) => {
  ...
  const { goal, days_available, minutes, style, equipment, experience } = validate(PlanWeekSchema, body);
  ...
  try {
    const systemPrompt = `Create a workout plan that uses ONLY the user's available equipment and expresses ALL loads in pounds (lb). No vague loads like 50s/50s.`+` Return ONLY valid JSON matching this exact schema: Return ONLY valid JSON matching this exact schema:
{
  "plan": [
    {
      "day": "Monday",
...
const eqHeader = eqInfo.lines.length ? `Available Equipment:
- ${eqInfo.lines.join('
...
Make it practical, progressive, and safe. Scale suggested loads to the listed intensity and equipment. Return only the JSON object.`;
    ...
    if (aiText) {
      try {
        ...
        if (parsed.plan && parsed.benefits && Array.isArray(parsed.plan) && parsed.plan.length > 0) {
          return new Response(JSON.stringify({
            success: true,
            data: parsed
          }), { headers: { 'Content-Type': 'application/json' } });
